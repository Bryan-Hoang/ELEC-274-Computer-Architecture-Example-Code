...
L1:
	...
	movai	r5, EIGHTSEG	# address of 8-segment display
	stwio	r3, 0(r5)		# write pattern to display
	movai	r5, Ondisp		# address of local where we store a copy
	stw		r3, 0(r5)
	# done
Restore:
